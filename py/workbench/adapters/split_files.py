#!/usr/bin/env python3
"""
Split NDJSON record content on marker lines and emit section records.

Input: NDJSON records on stdin.
Output: NDJSON records on stdout, one per emitted section.
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Split record content on marker lines and emit section records."
    )
    parser.add_argument(
        "--pattern",
